...
const Terms: React.FC = () => {
  return (
    <section className="min-h-screen bg-white text-black p-8 whitespace-pre-wrap font-sans leading-relaxed">
      ...
      <div>
        ...
        The Platform is owned by Hashforgamers Pvt Ltd
        , a company incorporated under the Companies
        Act, 1956 with its registered office at A-104 Asmita Garden -1 Poonam Sagar Mira Road
        Mumbai ,Mumbai ,India
